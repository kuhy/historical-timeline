...
import cz.muni.fi.timeline.TimelinePersistenceApplicationContext;
...
/**
 * tests for historicalTimeline DAO
 * @author Matej Macák
 */
@ContextConfiguration(classes = TimelinePersistenceApplicationContext.class)
